...
var G__26749 = cljs.core.next(items);
items = G__26749;
continue;
} else {
return arr;
...
var x26710 = error;
(x26710.cljs$core$IPrintWithWriter$ = cljs.core.PROTOCOL_SENTINEL);

(x26710.cljs$core$IPrintWithWriter$_pr_writer$arity$3 = (function (_obj,writer,opts){
var _obj__$1 = this;
...
var G__26751 = Object.getPrototypeOf(o);
o = G__26751;
continue;
} else {
...
var or__4185__auto__ = (cljs.core.truth_(wrap_QMARK_)?(function (){var temp__5739__auto__ = (goog.global["devtools"]);
