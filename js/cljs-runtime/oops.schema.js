...
var G__26995 = cljs.core.first(element_str);
switch (G__26995) {
case "?":
arr.push((1));
...
var G__27001 = cljs.core.next(items);
items = G__27001;
continue;
} else {
return null;
...
var G__27007 = cljs.core.next(items);
items = G__27007;
continue;
} else {
return null;
...
while(true){
if(items){
if(cljs.core.truth_((function (){var G__26996 = cljs.core.first(items);
return (is_valid_QMARK_.cljs$core$IFn$_invoke$arity$1 ? is_valid_QMARK_.cljs$core$IFn$_invoke$arity$1(G__26996) : is_valid_QMARK_.call(null,G__26996));
})())){
var G__27012 = cljs.core.next(cljs.core.next(items));
items = G__27012;
continue;
} else {
return true;
...
switch (G__26999) {
case (0):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_(path,(function (p1__26997_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__26997_SHARP_,(2));
})))){
...
break;
case (1):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_(path,(function (p1__26998_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__26998_SHARP_,(1));
})))){
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__26999)].join('')));
